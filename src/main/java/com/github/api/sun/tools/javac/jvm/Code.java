...
import static com.github.api.sun.tools.javac.code.TypeTag.INT;
import static com.github.api.sun.tools.javac.jvm.ByteCodes.*;
import static com.github.api.sun.tools.javac.jvm.ClassWriter.StackMapTableFrame;
import static com.github.api.sun.tools.javac.jvm.UninitializedType.*;
    ...
    static class LocalVar {
        ...
        public String toString() {
            ...
            for (Range r : aliveRanges) {
                sb.append(" starts at pc=").append(Integer.toString(r.start_pc))
                        .append(" length=").append(Integer.toString(r.length))
                        .append("\n");
            }
            return sb.toString();
        }
