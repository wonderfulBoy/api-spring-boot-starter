package com.github.api.sun.tools.javac.sym;
...
import com.github.api.sun.tools.javac.code.Symbol.PackageSymbol;
import com.github.api.sun.tools.javac.code.Symbol.TypeSymbol;
import com.github.api.sun.tools.javac.jvm.ClassWriter;
...
import com.github.api.sun.tools.javac.util.Pair;
...
@SupportedOptions({
        "com.github.api.sun.tools.javac.sym.Jar",
        "com.github.api.sun.tools.javac.sym.Dest",
        "com.github.api.sun.tools.javac.sym.Profiles"})
@SupportedAnnotationTypes("*")
public class CreateSymbols extends AbstractProcessor {
    static Set<String> getLegacyPackages() {
        ResourceBundle legacyBundle
                = ResourceBundle.getBundle("com.github.api.sun.tools.javac.resources.legacy");
    ...
    public static void main(String... args) {
        ...
        args = new String[]{
                ...
                "-proc:only",
                "-processor",
                "com.github.api.sun.tools.javac.sym.CreateSymbols",
                "-Acom.github.api.sun.tools.javac.sym.Jar=" + rt_jar,
                "-Acom.github.api.sun.tools.javac.sym.Dest=" + dest,
                ...
                "org.xml.sax.ext",
                "org.xml.sax.helpers",
                "com.github.api.sun.java.browser.dom",
                "org.w3c.dom",
                "org.w3c.dom.bootstrap",
                "org.w3c.dom.ls",
                "org.w3c.dom.ranges",
                ...
                "org.w3c.dom.events",
                "org.w3c.dom.views",
                "com.github.api.sun.management",
                "com.github.api.sun.security.auth",
                "com.github.api.sun.security.auth.callback",
                "com.github.api.sun.security.auth.login",
                "com.github.api.sun.security.auth.module",
                "com.github.api.sun.security.jgss",
                "com.github.api.sun.net.httpserver",
                "com.github.api.sun.net.httpserver.spi",
                "javax.smartcardio"

        };
        com.github.api.sun.tools.javac.Main.compile(args);
    }
    ...
    void createSymbols() throws IOException {
        ...
        String jarName = pOptions.get("com.github.api.sun.tools.javac.sym.Jar");
        if (jarName == null)
            throw new RuntimeException("Must use -Acom.github.api.sun.tools.javac.sym.Jar=LOCATION_OF_JAR");
        String destName = pOptions.get("com.github.api.sun.tools.javac.sym.Dest");
        if (destName == null)
            throw new RuntimeException("Must use -Acom.github.api.sun.tools.javac.sym.Dest=LOCATION_OF_JAR");
        String profileSpec = pOptions.get("com.github.api.sun.tools.javac.sym.Profiles");
        if (profileSpec == null)
            throw new RuntimeException("Must use -Acom.github.api.sun.tools.javac.sym.Profiles=PROFILES_SPEC");
        ...
        com.github.api.sun.tools.javac.main.JavaCompiler compiler =
                com.github.api.sun.tools.javac.main.JavaCompiler.instance(task.getContext());
