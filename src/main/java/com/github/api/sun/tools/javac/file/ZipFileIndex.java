...
import com.github.api.sun.tools.javac.file.RelativePath.RelativeDirectory;
import com.github.api.sun.tools.javac.file.RelativePath.RelativeFile;
...
public class ZipFileIndex {
    ...
    public synchronized com.github.api.sun.tools.javac.util.List<String> getFiles(RelativeDirectory path) {
        try {
            checkIndex();
            DirectoryEntry de = directories.get(path);
            com.github.api.sun.tools.javac.util.List<String> ret = de == null ? null : de.getFiles();
            if (ret == null) {
                return com.github.api.sun.tools.javac.util.List.nil();
            }
            return ret;
        } catch (IOException e) {
            return com.github.api.sun.tools.javac.util.List.nil();
    ...
    public synchronized List<String> getDirectories(RelativeDirectory path) {
        try {
            checkIndex();
            DirectoryEntry de = directories.get(path);
            com.github.api.sun.tools.javac.util.List<String> ret = de == null ? null : de.getDirectories();
            if (ret == null) {
                return com.github.api.sun.tools.javac.util.List.nil();
            }
            return ret;
            ...
            try {
                ...
                if (zipFile.lastModified() != fileStamp) {
                    ...
                    for (int nDirs = 0; nDirs < numDirs; nDirs++) {
                        ...
                        RelativeDirectory dirNameStr = getRelativeDirectory(new String(dirNameBytes, StandardCharsets.UTF_8));
    ...
    private boolean writeIndex() {
        ...
        try {
            ...
            for (RelativeDirectory dirName : directories.keySet()) {
                ...
                byte[] dirNameBytes = dirName.getPath().getBytes(StandardCharsets.UTF_8);
            ...
            for (DirectoryEntry de : directoriesToWrite) {
                ...
                for (Entry zfie : list) {
                    ...
                    byte[] zfieNameBytes = zfie.name.getBytes(StandardCharsets.UTF_8);
    ...
    static class DirectoryEntry {
        ...
        private com.github.api.sun.tools.javac.util.List<String> zipFileEntriesFiles = com.github.api.sun.tools.javac.util.List.nil();
        private com.github.api.sun.tools.javac.util.List<String> zipFileEntriesDirectories = com.github.api.sun.tools.javac.util.List.nil();
        private com.github.api.sun.tools.javac.util.List<Entry> zipFileEntries = com.github.api.sun.tools.javac.util.List.nil();
        ...
        private com.github.api.sun.tools.javac.util.List<String> getFiles() {
            if (!filesInited) {
                initEntries();
                for (Entry e : entries) {
                    if (!e.isDir) {
        ...
        private com.github.api.sun.tools.javac.util.List<String> getDirectories() {
        ...
        private com.github.api.sun.tools.javac.util.List<Entry> getEntries() {
            if (!zipFileEntriesInited) {
                initEntries();
                zipFileEntries = com.github.api.sun.tools.javac.util.List.nil();
                ...
                if (indexFile != null) {
                    ...
                    try {
                        ...
                        for (int nFiles = 0; nFiles < numEntries; nFiles++) {
                            ...
                            String eName = new String(zfieNameBytes, StandardCharsets.UTF_8);

                            boolean eIsDir = raf.readByte() != (byte) 0;
        ...
        private int readEntry(int pos, List<Entry> entryList,
            ...
            if (fileStart != fileEnd) {
                Entry entry = new Entry(directory,
                        new String(zipDir, fileStart, fileEnd - fileStart, StandardCharsets.UTF_8));
