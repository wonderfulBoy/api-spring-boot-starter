...
import com.github.api.sun.tools.javac.code.Attribute.Compound;
...
import static com.github.api.sun.tools.javac.code.Flags.ANNOTATION;
import static com.github.api.sun.tools.javac.code.Flags.SYNCHRONIZED;
import static com.github.api.sun.tools.javac.code.Flags.*;
import static com.github.api.sun.tools.javac.code.Kinds.*;
import static com.github.api.sun.tools.javac.code.TypeTag.WILDCARD;
...
public class Check {
    ...
    private Type firstIncompatibleTypeArg(Type type) {
        ...
        while (args.nonEmpty() && tvars_cap.nonEmpty()) {
            ...
            args.head.withTypeVar(tvars_cap.head);
            args = args.tail;
    ...
    private boolean isDeprecatedOverrideIgnorable(MethodSymbol m, ClassSymbol origin) {
        ...
        if (mc != null && ((mc.flags() & INTERFACE) != 0)) {
            ...
            return (!intfs.contains(mc.type) && (stimpl != null));
        } else
            return (stimpl != m);
    }
    ...
    public void checkClassOverrideEqualsAndHashIfNeeded(DiagnosticPosition pos,
        ...
        if (someClass == syms.objectType.tsym ||
    ...
    public interface CheckContext {
        ...
        Warner checkWarner(DiagnosticPosition pos, Type found, Type req);
