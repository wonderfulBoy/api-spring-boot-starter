...
import com.github.api.sun.tools.doclets.formats.html.markup.RawHtml;
import com.github.api.sun.tools.doclets.internal.toolkit.Content;

public class LegacyTaglet implements Taglet {
    private com.github.api.sun.tools.doclets.Taglet legacyTaglet;

    public LegacyTaglet(com.github.api.sun.tools.doclets.Taglet t) {
        legacyTaglet = t;
    }
