...
import com.github.api.sun.javadoc.ParameterizedType;
...
public class ParameterizedTypeImpl extends AbstractTypeImpl implements ParameterizedType {
    ...
    public com.github.api.sun.javadoc.Type[] typeArguments() {
    ...
    public com.github.api.sun.javadoc.Type containingType() {
