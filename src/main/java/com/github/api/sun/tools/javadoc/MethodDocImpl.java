...
public class MethodDocImpl
    ...
    public com.github.api.sun.javadoc.Type returnType() {
        return TypeMaker.getType(env, sym.type.getReturnType(), false);
    }

    public ClassDoc overriddenClass() {
        com.github.api.sun.javadoc.Type t = overriddenType();
        return (t != null) ? t.asClassDoc() : null;
    }

    public com.github.api.sun.javadoc.Type overriddenType() {
