...
import com.github.api.sun.source.util.Plugin;
...
import com.github.api.sun.tools.javac.file.CacheFSInfo;
...
import com.github.api.sun.tools.javac.processing.AnnotationProcessingError;
...
public class Main {
    ...
    public static final String javacBundleName =
            "com.github.api.sun.tools.javac.resources.javac";
    public Log log;
    ...
    public Collection<File> processArgs(String[] flags, String[] classNames) {
        ...
        if (showClass != null) {
            if (showClass.equals("showClass"))
                showClass = "com.github.api.sun.tools.javac.Main";
            showClass(showClass);
        }
